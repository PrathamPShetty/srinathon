...
from .serializers import MyTokenObtainPairSerializer, RegisterSerializer, ProfileSerializer, RegisterServiceSerializer
...
from .serializers import RegisterServiceSerializer
